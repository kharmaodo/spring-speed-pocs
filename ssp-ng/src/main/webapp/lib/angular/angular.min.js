...
(function (T, Y, p) {
    ...
    function Cb(b) {
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$http", "$templateCache", "$parse", "$controller", "$rootScope", function (b, h, j, k, l, o, r, n) {
            ...
            function ba(a, b, c, d, e, f, j) {
                var h = [], n, o, r = c[0], q = a.shift(), w = y({}, q, {
                    controller: null,
                    templateUrl: null,
                    transclude: null,
                    scope: null
            ...
            function G(a, b) {
                var c = h(b, !0);
                c && a.push({
                    priority: 0, compile: H(function (a, b) {
    ...
    function Jc(b, a) {
        ...
        for (var o = [], r, n = 0, w = [], q, x = ":"; n < b.length;) {
            ...
            }), c("{[") && w.unshift(q), c("}]") && w.shift(), n++; else if (g(q)) {
                n++;
                continue
            } else {
                var m = q + d(), A = Ka[q], s = Ka[m];
                s ? (o.push({index: n, text: m, fn: s}), n += 2) : A ? (o.push({
                    index: n,
                    text: q, fn: A, json: "[,:".indexOf(x) != -1 && c("+-")
    ...
    m({
        data: vb, inheritedData: Ca, scope: function (b) {
            return Ca(b, "$scope")
    ...
    m({
        removeData: tb, dealoc: ra, bind: function a(c, d, e) {
    ...
    var Ka = {
        ...
        "'": "'",
        '"': '"'
    }, ib = {}, Xc = T.XMLHttpRequest || function () {
            try {
    ...
    }, jd = Ra(), kd = Ra(!0), ld = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/, md = /^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,4}$/, nd = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, bc = {
        text: Qa, number: function (a,
                                    c, d, e, g, i) {
            Qa(a, c, d, e, g, i);
    ...
    }], xd = kb("", !0), yd = kb("Odd", 0), zd = kb("Even", 1), Ad = R({
            ...
            require: ["select", "?ngModel"], controller: ["$element", "$scope", "$attrs", function (a, c, d) {
                ...
                function l(e, f, g) {
                    function h() {
                        ...
                        u = !1;
                        var B, D;
                        if (n)u = new Ea(t); else if (t === null || q)a[""].push({
                            selected: t === null,
                            id: "",
                            label: ""
                        }), u = !0;
                        ...
                        for (x = c.length; w < x; w++) {
                            ...
                            if (s.length <= w)t = {
                                ...
                                label: i.label
                            }, v = [t], s.push(v), f.append(t.element); else if (v = s[w], t = v[0], t.label != d)t.element.attr("label", t.label = d);
                            B = null;
                            y = 0;
